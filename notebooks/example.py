...
meetup_client.get(
    url="PyData-Suedwest/similar_groups"
)
...
meetup_client.get(
    ...
    zip="69123",
    country="Germany"
).sort_values("members", ascending=False)[["name", "city", "members"]].head(20).reset_index(drop=True)
...
meetup_client.scroll(
    url="PyData-Suedwest/members",
    only="id,name,group_profile.created",
)
